...
elseif whatdata == 2 
    ...
    file8 = xlsread('Data\Series_B1\Sham m2 ABM_S6A LH ROI.tif Plaque Analysis.csv');
    file9 = xlsread('Data\Series_B1\Sham m3 ABM_S3A LH ROI.tif Plaque Analysis.csv');
    plaques_sham = [file7(:,2) ; file8(:,2) ; file9(:,2)]';
end 
...
% trying to keep x and Y coordinates of plaque; protocolmX = [ plaque, xcoord, ycoord] 
